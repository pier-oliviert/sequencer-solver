module github.com/pier-oliviert/solver.quencer.io
...
require (
	...
	github.com/pier-oliviert/external-dns v0.0.0-20240711180404-77ebaa661ebb
	github.com/pier-oliviert/sequencer v0.0.0-20240716125138-a3a4382e5047
